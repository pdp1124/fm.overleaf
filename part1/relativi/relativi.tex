...
corrispondente del marziano\footnote{Un caro amico, leggendo le bozze di queste note,
...
cannocchiale, assumono il nome speciale di {\em velocit\`a di trascinamento}\index{velocit\`a!di trascinamento}, ovviamente variabile da punto a punto del sistema relativo
\begin{equation}
...
\noindent Esaminiamo ora la scala della figura \ref{e115} che, anzich\'e appoggiarsi al muro verticale
...
una domanda: gli esercizi di figura \ref{fig:f114} e di figura \ref{e115}
...
rispetto alla Terra.
Oltre al valido argomento, che quasi tutti conoscono,
