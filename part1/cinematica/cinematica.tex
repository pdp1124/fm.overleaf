...
{\em aste}, {\em bilancieri}, \index{bilanciere}{\em ruote dentate}, \index{ruote
dentate} {\em telai}, \index{telaio} sono tutti {\em corpi rigidi}. 
...
\section{Teorema di Chasles}\index{Chasles, teorema}
...
{\em centro d'istantanea rotazione}\index{centro d'istantanea rotazione}\footnote{
...
{\em teorema di Rivals},\index{Rivals, teorema} \cite{sesini1}, pag. 12.
}.	
...
di un generico punto $K$, otteniamo
dalla \ref{e115}
...
{ Qualora il punto $P$ fosse centro d'istantanea rotazione (e non di una rotazione
finita),
...
e possiamo scrivere la loro differenza infinitesimale sempre con l'aiuto della figura:
...
\noindent dove il vettore ${\rm d}{\bm \theta}$ \`e
ortogonale al piano del disegno, pertanto non viene rappresentato in figura se non tramite il proprio simbolo.
...
velocit\`a e la {\em curvatura della traiettoria}\index{curvatura
della traiettoria} percorsa da $Q$. 
