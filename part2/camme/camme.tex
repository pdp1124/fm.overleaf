\chapter{Leggi di Moto e Profilatura delle Camme}\index{eccentrici}
\label{camme}
...
costretto a compiere la legge costituita dal profilo della sagoma stessa. La {\em camma lineare}\index{camma lineare}
...
sul quale sar\`a presente la {\em camma}\index{camma}, si completer\`a un intero ciclo del diagramma delle alzate.
...
{\em leggi di moto}\index{leggi di moto} diverse,
...
costante tagliata}\index{accelerazione costante} dove si nota
...
La legge con {\em accelerazione sinusoidale tagliata}\index{accelerazione
...
citata poc'anzi presenta bassi valori di {\em jerk}\index{jerk@{\em jerk}} (cos\`i viene
...
\noindent Si compone di sette tratti: sinusoide, costante, sinusoide, nulla, sinusoide,
...
Si ha per il raggio del percorso del  ``centro rotella''
\begin{equation}
...
{\em camme offset}\index{camme {\em offset}}.
...
{\em camma coniugata}\index{camma coniugata} o {\em camma desmodromica}\index{camma desmodromica}, riportata in colore rosa
...
camma coniugata}\index{camma coniugata}, e questo modo di 
