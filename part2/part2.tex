...
si parler\`a di
{\em trasmissioni}\index{trasmissioni}
...
\begin{wrapfigure}{r}{0.5\textwidth}
     ...
     \end{center}
        \caption{\em Ruota dentata.}\index{ruote!dentate}
     \label{fig:f2a}
\end{wrapfigure}
...
profondit\`a.
Introdurremo cos\`i i {\em sistemi articolati}\index{sistemiearticolati}, in particolare i quadrilateri, che possono trasformare 
...
Vi sono poi i {\em manovellismi}\index{manovellismi} (casi degeneri dei
...
\input{./part2/ruote/ruote.tex}
\input{./part2/quadri/quadri.tex}
\input{./part2/manovellismi/manovellismi.tex}
\input{./part2/camme/camme.tex}
