...
non ordinari}.\index{manov. non ordinari}
...
invece un
{\em manovellismo ordinario deviato}\index{manov. ordinario deviato}
...
membri appropriati,
i {\em manovellismi non ordinari}\index{manov. non ordinari}. Questi manovellismi, ovviamente {\em cinematicamente
...
centrati}\index{manov. non ordinari}.
...
\put(160,75){\tiny biella equivalente}
\put(158,75){\rotatebox{220}{$\longrightarrow$}}
\put(268,86){\tiny biella equivalente}
\put(254,85){\rotatebox{180}{$\longrightarrow$}}
\put(94,14){\tiny glifo}
\put(90,22){\rotatebox{180}{$\longrightarrow$}}
\put(145,45){\tiny glifo}
\put(154,41){\rotatebox{0}{$\longrightarrow$}}
...
\section{Meccanismo a Ritorno Rapido}\index{meccanismo a ritorno rapido}\index{guida di {\em Fairbairn}}
...
\end{picture}
 ...
 \label{fig:fairbairn}
\end{figure}
\noindent La {\em guida di Fairbairn}\index{glifo di {\em Fairbairn}}\index{Fairbairn@{\em Fairbairn} guida},
...
\noindent ovvero, 
\begin{equation}
{\omega_{\rm m}}|\overrightarrow{AB}|\widehat{{\perp{AB}}}=
{{\bm v}_{\scriptscriptstyle{B}}}_{\scriptscriptstyle{{\rm rel}}}+
...
e normali ottenendo
\begin{equation}
-{\omega_{\rm m}}^2 \overrightarrow{AB} + \dot{\omega}_{\rm m}|\overrightarrow{AB}|\widehat{{\perp{AB}}}=
{{\bm a}_{\scriptscriptstyle{B}}}_{\scriptscriptstyle{{\rm rel}}} 
...
di questa equazione.
Contando poi i termini della \ref{eq:acc_glifo_graf1} da sinistra, tralasciando
la presenza del segno di uguaglianza, affermiamo che gli unici moduli incogniti
sono quelli dei vettori che occupano il terzo e il quinto posto. 
...
il {\em giunto di {\em Oldham}}\index{giunto di {\em Oldham}}.
