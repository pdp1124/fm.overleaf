...
e $\bm \Gamma$
costituite ciascuna 
da tre versori ortogonali, che si possono  
assumere quali {\em vettori di base} per
gli spazi fisso e mobile, come in figura \ref{fig:f11_app11}.
...
Abbiamo cos\`i gli {\em angoli di Eulero}\index{angoli di {\em Eulero}}: {\em
...
$\theta$, $\phi$  e $\psi$,
\cite{whittaker}, pagg. 8--12, gli {\em angoli di Cardano}\index{angoli
di {\em Cardano}}, meno noti e non molto dissimili da quelli di {\em Eulero} e talvolta
...
\noindent Rimane a questo punto da chiarire se, come nel caso piano, vi siano dei punti
...
dello spazio mobile, traslano, restando sulla stessa retta.
...
di {\em Chasles},
oppure con l'{\em asse del Mozzi}\index{asse del {\em Mozzi}}\footnote
{
...
il contenuto di tale teorema,\index{teorema di {\em Chasles}}
...
Riportiamo esclusivamente le quantit\`a legate alla figura
...
{\em asse d'istantanea  rotazione}\index{asse d'istantanea rotazione}.
