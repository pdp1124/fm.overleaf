%\newpage
\chapter{Approfondimenti sulla Profilatura delle Camme
}\label{cam2}
...
\section{Un Metodo per Ridurre l'Ingombro delle Camme}\index{camme {\em offset}}\index{camme}
...
costringendo il progettista ad aumentare le dimensioni della camma,
e quindi quelle della macchina, onde evitare gli
...
i valori di $\theta_{\rm max}$
 differiscono di poco pi\`u di $6^{\circ}$,
...
\noindent Torniamo quindi alla nostra camma a bilanciere\index{camma a bilanciere},
...
verifica
nelle guide di scorrimento di punterie impegnate da notevoli forze
...
accelerazioni in millimetri su secondo quadro, quella delle velocit\`a
in millimetri al secondo, infine quella dell'alzata
in millimetri.},
...
Tale interpolazione, svolta tramite {\em spline cubiche}\index{spline@{\em spline}},
